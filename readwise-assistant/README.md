...
# Install the plugin
/plugin install readwise-assistant@skills
```
...
```bash
claude --plugin-dir ./readwise-assistant
```
...
https://github.com/ethanolivertroy/skills/issues
