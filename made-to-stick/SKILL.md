...
> Based on *[Made to Stick: Why Some Ideas Survive and Others Die](https://heathbrothers.com/made-to-stick/)* by **Chip Heath & Dan Heath**
...
3. Score each section against SUCCESs principles (see `sticky-evaluation.md`)
...
- `SUCCESS-FRAMEWORK.md` - Deep dive on each principle with extended examples
- `WRITING-PLAYBOOK.md` - Writing-specific applications (headlines, copy, pitches, docs)
- `sticky-evaluation.md` - Copyable evaluation checklist
