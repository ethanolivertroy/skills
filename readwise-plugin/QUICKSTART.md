...
```bash
cd /Users/ethantroy/Git/Github/claude-plugins/readwise-plugin
claude --plugin-dir .
```
...
{
  "plugins": [
    "/Users/ethantroy/Git/Github/claude-plugins/readwise-plugin"
  ]
}
```
...
- **Full README**: `/Users/ethantroy/Git/Github/claude-plugins/readwise-plugin/README.md`
- **Implementation Plan**: `~/.claude/plans/glistening-honking-bird.md`
